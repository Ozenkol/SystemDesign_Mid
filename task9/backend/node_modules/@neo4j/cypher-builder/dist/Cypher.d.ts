...
export { contains, endsWith, eq, gt, gte, inOp as in, isNormalized, isNotNormalized, isNotNull, isNull, lt, lte, matches, neq, startsWith, type ComparisonOp, } from "./expressions/operations/comparison";
