...
exports.FieldAggregationComposer = void 0;
...
class FieldAggregationComposer {
    ...
    createAggregationTypeObject(relationshipAdapter, features) {
        ...
        if (relationshipAdapter instanceof RelationshipAdapter_1.RelationshipAdapter && relationshipAdapter.attributes.size > 0) {
    ...
    getAggregationFields(entity, features) {
        return entity.aggregableFields.reduce((res, field) => {
            ...
            if (field.typeHelper.isID()) {
                if ((0, utils_1.shouldAddDeprecatedFields)(features, "idAggregations")) {
                    res[field.name] = { type: objectTypeComposer.NonNull, directives: [constants_1.DEPRECATE_ID_AGGREGATION] };
                }
                return res;
            }
            else {
