...
class AggregationOperation extends operations_1.Operation {
    ...
    transpile(context) {
        ...
        const isTopLevel = !(this.entity instanceof RelationshipAdapter_1.RelationshipAdapter);
        if (isTopLevel) {
            const clausesSubqueries = clauses.flatMap((sq) => new cypher_builder_1.default.Call(sq));
            return {
    ...
    createSubquery(field, pattern, returnVariable, context, target = "node") {
        ...
        return cypher_builder_1.default.utils.concat(matchClause, ...selectionClauses, ...nestedSubqueries, extraSelectionWith, ret);
    }
}
